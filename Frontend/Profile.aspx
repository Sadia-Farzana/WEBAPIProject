	...
	<div class="row">
		<div class="col-md-3 ">
		     <div class="list-group ">
              ...
              <a href="AllUser.aspx" class="list-group-item list-group-item-action">Userlist</a>
		                ...
		                <div class="col-md-12">
                              ...
                              <div class="form-group row">
                                <div class="offset-4 col-8">
                                  <Button onclick="UpdateUser()" class="btn btn-primary">Update My Profile</Button>
                                </div>
                              </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-4 col-form-label">Username</label>
                                    <div class="col-8">
                                        <input id="txtusername" class="form-control here" type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lastname" class="col-4 col-form-label">Email</label>
                                    <div class="col-8">
                                        <input id="txtemail" class="form-control here" type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="text" class="col-4 col-form-label">Password</label>
                                    <div class="col-8">
                                        <input id="txtpassword" class="form-control here" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-4 col-form-label">Contact Number</label>
                                    <div class="col-8">
                                        <input id="txtphone" class="form-control here" type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="website" class="col-4 col-form-label">Address</label>
                                    <div class="col-8">
                                        <input id="txtaddress" class="form-control here" type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="publicinfo" class="col-4 col-form-label">Role</label>
                                    <div class="col-8">
                                        <input id="txtrole" class="form-control here" type="text">
                                    </div>
                                </div>
        ...
        <div id="Errordiv" class="alert alert-danger collapse">
                <a id="cl" class="close" href="#">&times;</a>
